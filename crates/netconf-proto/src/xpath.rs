...
mod tests {
    ...
    /// that gate lives with callers (e.g.
    /// `DatastoreXPathFilter::path_prefixes`).
    #[test]
    ...
    fn test_xpath_diff_clamps_overlapping_prefix_and_suffix() {
        ...
        assert_eq!(xpath_diff("aba", "aa"), (1, "b".to_string(), String::new()),);
    }
    ...
    fn test_xpath_diff_is_char_boundary_safe_with_multibyte_input() {
        ...
        let (diverges_at, provided_unique, canonical_unique) = xpath_diff("/αβ:x/y", "/αβ:x/z");
    ...
    fn test_strip_xpath_predicates_removes_nested_predicates() {
        ...
        assert_eq!(strip_xpath_predicates("/a:x[a:y[a:z='w']]/a:q"), "/a:x/a:q",);
    }
